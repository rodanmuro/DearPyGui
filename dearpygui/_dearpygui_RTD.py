...
def add_axis_tag(**kwargs):
	...
	return internal_dpg.add_axis_tag(**kwargs)

def add_bar_group_series(values, label_ids, group_size, **kwargs):
	...
	return internal_dpg.add_bar_group_series(values, label_ids, group_size, **kwargs)
